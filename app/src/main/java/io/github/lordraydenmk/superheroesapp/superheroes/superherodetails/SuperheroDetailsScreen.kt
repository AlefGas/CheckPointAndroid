...
fun SuperheroContent(content: Content) {
    Column(
        ...
        Text(text = content.superhero.name)

        Text(
            text = content.superhero.description
        )
        // Adicionando a data de modificação do super-herói
        Text(
            text = "Last modified: ${content.superhero.modified}",
